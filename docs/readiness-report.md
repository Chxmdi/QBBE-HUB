...
|---|---|
| Candidate | Epic 01 merged to `main` at `698c52f`. Epic 02 mostly on `main`: #26 landed through PR #72; #27, #28 and #76 landed together through PR #78, merged at `5c77f97` on 2026-09-21, after PR #74 and PR #77 were merged in the wrong order and left the #76 commits on a branch that had already been merged out. #31 is the only Epic 02 issue still open; epic #12 was reopened on 2026-09-21 because it had been closed ahead of it. No certified release |
