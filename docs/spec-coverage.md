...
| 20 Search coverage | P0-CMD-01, P1-SRC-03, P0-UX-06 | Implemented | `global_search` covers 13 record types including risks, issues, documents and opportunities; results round-robin so no type is starved by the limit; deep links land on the row and highlight it; drift test ties SQL branches to UI labels; RLS assertions prove search is not a side door |
